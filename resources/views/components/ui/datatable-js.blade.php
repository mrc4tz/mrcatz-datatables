<div wire:init="showLoading" x-data="{
    ...
    @if($enableKeyboardNav && $posts->hasData())
        <div class="mt-2 flex items-center gap-3 text-[11px] text-base-content/30">
            <span class="flex items-center gap-1"><kbd class="kbd kbd-xs">&#8593;&#8595;</kbd> navigasi</span>
            <span class="flex items-center gap-1"><kbd class="kbd kbd-xs">Enter</kbd> edit</span>
            <span class="flex items-center gap-1"><kbd class="kbd kbd-xs">Del/&#9003;</kbd> hapus</span>
            <span class="flex items-center gap-1"><kbd class="kbd kbd-xs">Esc</kbd> batal</span>
        </div>
    @endif
