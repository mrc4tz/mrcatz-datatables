...
- Integration tests via `orchestra/testbench` with SQLite in-memory database
...
### Changed
- Localization now uses Laravel lang files instead of config-only approach
...
[Unreleased]: https://github.com/mrc4tz/mrcatz-datatables/compare/v1.0.2...HEAD
