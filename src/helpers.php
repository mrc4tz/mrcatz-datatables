    ...
    function mrcatz_icon_svg(string $name, string $class = ''): string
    {
        ...
        if ($svgMap === null) {
            $svgMap = [
                ...
                'description'             => '<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z"/>',
                ...
                'autorenew'               => '<path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182"/>',
                // Text input types (text, email, password, url, tel, number)
                'text_fields'             => '<path stroke-linecap="round" stroke-linejoin="round" d="M6.25 6.375a4.125 4.125 0 1 1 8.25 0 4.125 4.125 0 0 1-8.25 0ZM3.25 19.125a7.125 7.125 0 0 1 14.25 0v.003l-.001.119a.75.75 0 0 1-.363.63 13.067 13.067 0 0 1-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 0 1-.364-.63l-.001-.122ZM19.5 6.375v12"/>',
                ...
                // Hashtag (#) — associated with numbers / counting
                'numbers'                 => '<path stroke-linecap="round" stroke-linejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5-3.9 19.5m-2.1-19.5-3.9 19.5"/>',
                ...
                // Push-pin (map pin) — used by number() as the sensible default
                ...
                'calendar_today'          => '<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/>',
                // Calendar with explicit month grid — used by datetime()
                'calendar_month'          => '<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5M12 12.75h.008v.008H12v-.008ZM7.5 12.75h.008v.008H7.5v-.008ZM16.5 12.75h.008v.008H16.5v-.008ZM7.5 16.5h.008v.008H7.5V16.5ZM12 16.5h.008v.008H12V16.5ZM16.5 16.5h.008v.008H16.5V16.5Z"/>',
                // Calendar with range arrow — used by dateRange()
                'date_range'              => '<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 7.5h18M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75M8.25 13.5h7.5m0 0-2.25-2.25m2.25 2.25-2.25 2.25"/>',
                // Clock — used by time()
                'schedule'                => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>',
                'expand_more'             => '<path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5"/>',
                'expand_less'             => '<path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5"/>',
                ...
                'checklist'               => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>',
                // Person silhouette — name / user fields
                ...
                // Two short lines — short single-line text input
                'short_text'              => '<path stroke-linecap="round" stroke-linejoin="round" d="M4 7.5h16M4 13.5h10"/>',
                // Document with lines — multi-line / textarea
                'subtitles'               => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5a1.5 1.5 0 0 1 1.5 1.5v7.5a1.5 1.5 0 0 1-1.5 1.5H3.75a1.5 1.5 0 0 1-1.5-1.5v-7.5a1.5 1.5 0 0 1 1.5-1.5Zm2.25 6h3.75m3 0h6.75m-13.5 3h10.5"/>',
                // Quote marks — notes / quotes
                'format_quote'            => '<path stroke-linecap="round" stroke-linejoin="round" d="M7.5 8.25h3v3a3 3 0 0 1-3 3m9-6h3v3a3 3 0 0 1-3 3"/>',
            ];
        }
    ...
    function mrcatz_icon(string $name, string $class = ''): string
    {
        ...
        if ($iconSet === 'heroicons') {
            if ($heroMap === null) {
                $heroMap = [
                    ...
                    'autorenew' => 'arrow-path',
                    'event' => 'calendar', 'calendar_today' => 'calendar',
        ...
        if ($iconSet === 'material') {
            ...
            if (preg_match('/\bw-(\d+)\b/', $class, $m)) {
                ...
                $sizeStyle = 'font-size:' . ($sizeMap[$m[1]] ?? ($m[1] * 4) . 'px') . ';';
                $filteredClass = preg_replace('/\b[wh]-\d+\b/', '', $filteredClass);
                $filteredClass = trim(preg_replace('/\s+/', ' ', $filteredClass));
            }

            // Always force line-height:1 and inline-flex centering so the glyph
            // sits in the visual middle of its line-box (material icons are
            // font-based and otherwise inherit parent line-height, pushing the
            // glyph upward inside flex containers like form input labels).
            $baseStyle = 'line-height:1;display:inline-flex;align-items:center;justify-content:center;vertical-align:middle;';
            $styleAttr = ' style="' . $baseStyle . $sizeStyle . '"';
        ...
        if ($iconSet === 'fontawesome') {
            ...
            if ($faMap === null) {
                $faMap = [
                    ...
                    'picture_as_pdf' => 'fa-solid fa-file-pdf', 'description' => 'fa-solid fa-file-csv',
                    ...
                    'autorenew' => 'fa-solid fa-arrows-rotate',
                    'event' => 'fa-solid fa-calendar-days', 'calendar_today' => 'fa-solid fa-calendar-day',
                    'expand_more' => 'fa-solid fa-chevron-down', 'expand_less' => 'fa-solid fa-chevron-up',
                ];
            }
